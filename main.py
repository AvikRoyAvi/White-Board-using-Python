...
#icon
image_icon = PhotoImage(file='D:\Codes\Python\Projects\White Board using Python\icon.png')
root.iconphoto(False, image_icon)

color_box = PhotoImage(file='D:\Codes\Python\Projects\White Board using Python\color_section.png')
Label(root, image=color_box, bg='#f2f3f5').place(x=10, y=20)

eraser = PhotoImage(file='D:\Codes\Python\Projects\White Board using Python\eraser.png')
...
def display_pallete():
    ...
    id = colors.create_rectangle((10, 160, 30, 180), fill='brown4')
